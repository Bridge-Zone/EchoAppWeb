...
import { AppleIcon, GoodIcon, GoogleIcon, LoginIcon, PasswordIcon } from "../components/SvgGrabber";
      ...
      <div className="container-fluid p-0 d-flex">
        ...
        <div className="col-12 col-lg-5 login-main-div p-2">
            <div className="" style={{ width: "100%" }}>
              <h2 className=" mb-3 login-heading">Sign Up</h2>
              ...
              <p className="text-center mt-5 signUp-text">
                Don’t have an account? <a className="signUp-navigate" href="/signup">Signin</a>
              </p>
            </div>
